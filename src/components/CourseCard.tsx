...
const CourseCard: React.FC<CourseCardProps> = ({
  ...
  if (startDate) {
    courseStructuredData.offers["validFrom"] = startDate;
  }

  if (location) {
    courseStructuredData.provider["address"] = location;
  }
  ...
  return (
    <>
      ...
      <div className={cn("cetpro-card group overflow-hidden", featured ? "border-cetpro-gold/50" : "", "animate-fade-in")}>
